			...
			<section className="relative py-28 md:py-40 px-6 sm:px-10 lg:px-16 flex items-center justify-center text-center overflow-hidden">
				...
				<div className="relative z-10 max-w-4xl mx-auto space-y-6">
					...
					<p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed font-light">
						Ready to start your project or just have a question? Reach out
						to us!
					</p>
				</div>
			</section>
				...
				<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
					...
					<div className="bg-gray-900 p-8 rounded-2xl shadow-xl border border-gray-800 flex flex-col justify-between">
							...
							<div className="space-y-6 text-gray-400 text-lg">
								<div className="flex items-start">
									...
									<div>
										...
										<br />
										Sankara colony, west ramalingam road, R.S puram,
										coimbatore - 641002
									</div>
								</div>
								<div className="flex items-start">
									...
									<div>
										...
										<div className="flex flex-col items-center justify-center gap-1">
											<a
												href="tel:+91-8220548847"
												className="hover:text-emerald-400 transition-colors duration-300"
											>
												+91-822 0548 847
											</a>{" "}
											<a
												href="tel:+91-9789593505"
												className="hover:text-emerald-400 transition-colors duration-300"
											>
												+91-978 9593 505
											</a>{" "}
						...
						<div className="mt-8 rounded-lg overflow-hidden border border-gray-800 shadow-md">
							<iframe
								src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d483.6670862616306!2d76.94814785191004!3d11.003972580745033!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba8591a47289db7%3A0xb06d7aaabe193544!2sAnnur%20House%2C%20R.S.%20Puram%2C%20Coimbatore%2C%20Tamil%20Nadu%20641002!5e1!3m2!1sen!2sin!4v1775904887454!5m2!1sen!2sin"
								width="100%"
								height="250"
								style={{ border: 0 }}
								allowFullScreen=""
