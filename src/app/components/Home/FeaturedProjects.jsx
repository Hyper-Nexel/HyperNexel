...
const FeaturedProjects = () => {
	return (
		<section
			id="projects"
			className="relative bg-gray-950 text-white py-20 md:py-10 px-6 sm:px-10 lg:px-16 overflow-hidden"
		>
			{/* Decorative blobs */}
			...
			<div className="relative z-10 max-w-7xl mx-auto">
				...
				<div className="text-center mb-16">
					...
					<p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
						From e‑commerce storefronts to learning portals—we craft
						digital products that perform, scale, and look gorgeous doing
						it.
					</p>
				</div>
				{/* Projects grid */}
